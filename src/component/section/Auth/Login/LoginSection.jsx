...
export const LoginSection = () => {
  return (
    <div>
      <body className="bg-red-800 flex items-center justify-center min-h-screen">
        <div className="bg-yellow-50 rounded-lg shadow-lg p-8 w-auto relative">'
          ...
          <div className="flex justify-center mt-4">
            <button className="bg-white border border-gray-300 rounded-lg w-full p-2 flex items-center justify-center hover:bg-gray-100">
              <img
